...
public class DCfT extends JUnit_OP
{
	
	int cont=0;

	public DCfT(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit)
	{
   ...
   public void outputToFile(String ann)
   {
      ...
      String f_name;
      num++;
      f_name = getSourceNameAnn("DCfT", ann);
      String mutant_dir = getMuantID("DCfT");
      ...
      try 
      {
		 ...
		 DCfT_Writer writer = new DCfT_Writer(mutant_dir, out);
