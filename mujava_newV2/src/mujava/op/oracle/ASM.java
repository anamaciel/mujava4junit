...
/**
 * <p>Generate ASM (Adding String Message) mutants --
 *    Example: assertArrayEquals(int[], int[]) → assertArrayEquals(String, int[], int[])
 *    
 *    assertEquals
 *    assertArrayEquals
 *    assertNotEquals
...
public class ASM extends JUnit_OP
{

	public ASM(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit)
	{
