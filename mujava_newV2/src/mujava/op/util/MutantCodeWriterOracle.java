...
public class MutantCodeWriterOracle extends ParseTreeVisitor
{
		...
		public MutantCodeWriterOracle( PrintWriter out ) 
		{
			super();
			this.out = out;
		}

		public MutantCodeWriterOracle( String mutant_dir, PrintWriter out ) 
		{
			super();
			this.out = out;
